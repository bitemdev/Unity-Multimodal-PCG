...
namespace PCG.Modules.Audio
{
    public class MusicGenerator : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _stepDuration = 60f / _pcgConfig.BPM / 4f; // Calculate 1 step duration (sixteenth note)
        }
        ...
        private void OnEnable()
        {
            ...
            {
                _environmentManager.OnLevelGenerated += ComposeMusic;
            }
        }
        ...
        private void ComposeMusic(NativeList<SpawnPoint> spawnPoints)
        {
            ...
            for (int i = 0; i < _sequencerPattern.Length; i++)
            {
                ...
                if (rng.NextFloat() < noteProbability)
                {
                    ...
                    {
                        noteIndex = rng.NextInt(10, _pcgConfig.PentatonicScale.Length); // High
                    }
        ...
        private void PlayStep()
        {
            ...
            if (noteIndex != -1 && noteIndex < _pcgConfig.PentatonicScale.Length) // Not silence, it's a note
            {
                float frequency = _pcgConfig.PentatonicScale[noteIndex];
